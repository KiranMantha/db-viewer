...
(() => {
  ...
  var Icon = ({ name, color: color2 = "#fff", size = 18 }) => {
    if (name === "table") {
      return /* @__PURE__ */ g(
        "svg",
        {
    ...
    if (name === "save") {
      return /* @__PURE__ */ g(
        ...
        /* @__PURE__ */ g("ellipse", { class: "st0", stroke: color2, cx: "14", cy: "8", rx: "10", ry: "5" }),
        /* @__PURE__ */ g("line", { class: "st0", stroke: color2, x1: "24", y1: "16", x2: "24", y2: "8" }),
        /* @__PURE__ */ g("path", { class: "st0", stroke: color2, d: "M4,8v8c0,2.8,4.5,5,10,5c1.2,0,2.3-0.1,3.4-0.3" }),
        /* @__PURE__ */ g("path", { class: "st0", stroke: color2, d: "M4,16v8c0,2.8,4.5,5,10,5c2,0,3.8-0.3,5.3-0.8" }),
        /* @__PURE__ */ g("circle", { class: "st0", stroke: color2, cx: "24", cy: "23", r: "7" }),
        /* @__PURE__ */ g("line", { class: "st0", stroke: color2, x1: "24", y1: "16", x2: "24", y2: "26" }),
        /* @__PURE__ */ g("polyline", { class: "st0", stroke: color2, points: "21,23 24,26 27,23 " })
      );
    }
    return /* @__PURE__ */ g(
      "svg",
  ...
  function hsla(h3, s3, l3, a3) {
    if (a3 <= 0) h3 = s3 = l3 = NaN;
    else if (l3 <= 0 || l3 >= 1) h3 = s3 = NaN;
    else if (s3 <= 0) h3 = NaN;
  ...
  function hslConvert(o3) {
    ...
    o3 = o3.rgb();
    var r3 = o3.r / 255, g2 = o3.g / 255, b = o3.b / 255, min2 = Math.min(r3, g2, b), max2 = Math.max(r3, g2, b), h3 = NaN, s3 = max2 - min2, l3 = (max2 + min2) / 2;
    if (s3) {
      if (r3 === max2) h3 = (g2 - b) / s3 + (g2 < b) * 6;
      else if (g2 === max2) h3 = (b - r3) / s3 + 2;
      else h3 = (r3 - g2) / s3 + 4;
  ...
  var DBViewer = () => {
    ...
    const renderTreeNode = (table) => {
      ...
      return /* @__PURE__ */ g("li", { key: table.name }, /* @__PURE__ */ g("div", { className: "tree-node" }, /* @__PURE__ */ g("span", { className: "cursor", onClick: () => toggleNode(table.name) }, table.columns ? /* @__PURE__ */ g(Icon, { name: isExpanded ? "chevron-down" : "chevron-right" }) : null), /* @__PURE__ */ g("span", { className: "tree-name", onClick: () => getRecordsFromTable(table.name) }, table.name)), table.columns && isExpanded && /* @__PURE__ */ g("ul", null, table.columns.map(({ name, type: type2, isPrimaryKey, isForeignKey }) => /* @__PURE__ */ g("li", { key: `${table.name}-${name}-${type2}`, className: "leaf-node" }, /* @__PURE__ */ g("span", { className: "leaf-name" }, name), /* @__PURE__ */ g("span", null, "(", type2, ")"), isPrimaryKey ? /* @__PURE__ */ g(Icon, { name: "tag", color: "#ffff00", size: 12 }) : null, isForeignKey ? /* @__PURE__ */ g(Icon, { name: "tag", color: "#0d6efd", size: 12 }) : null))));
    };
    ...
    return /* @__PURE__ */ g(k, null, /* @__PURE__ */ g("aside", null, /* @__PURE__ */ g("h2", null, "Tables"), /* @__PURE__ */ g("ul", null, tables.map((table) => renderTreeNode(table)))), /* @__PURE__ */ g("main", null, /* @__PURE__ */ g("div", { className: "table-actions" }, /* @__PURE__ */ g("button", { onClick: handleToggleSchema }, showERDiagram ? "Hide" : "View", " DB ER Diagram")), showERDiagram && dbSchema ? /* @__PURE__ */ g(ERDiagram, { schema: dbSchema }) : null, !showERDiagram && tableInfo ? /* @__PURE__ */ g(k, null, /* @__PURE__ */ g("div", { className: "table-responsive" }, /* @__PURE__ */ g("table", null, /* @__PURE__ */ g("thead", null, /* @__PURE__ */ g("tr", null, headers.map((header) => /* @__PURE__ */ g("th", { key: header.name }, header.name, " ", header.isPrimaryKey ? "(PK)" : header.isForeignKey ? "(FK)" : "")), /* @__PURE__ */ g("th", null))), /* @__PURE__ */ g("tbody", null, rows.map((row, index) => /* @__PURE__ */ g("tr", { key: index }, headers.map((header) => /* @__PURE__ */ g("td", { key: header.name }, header.isPrimaryKey ? /* @__PURE__ */ g(
      "form",
      {
        method: "GET",
