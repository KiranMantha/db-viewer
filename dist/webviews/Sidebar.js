...
(() => {
  ...
  // webviews/src/components/Button.tsx
  function Button(props) {
    return /* @__PURE__ */ u3("button", { ...props });
  }

  // webviews/src/pages/Sidebar.tsx
  var App = () => {
    ...
    const handleExpandTable = (tableName) => {
    ...
    const handleMessage = (event) => {
      ...
      if (message.command === "SHOW_TABLES") {
        setTables(message.tables.map((table) => ({ tableName: table, columns: [] })));
      } else if (message.command === "SHOW_COLUMNS") {
        setTables(
          (prev) => prev.map((table) => table.tableName === message.tableName ? { ...table, columns: message.columns } : table)
        );
      }
    };
    y2(() => {
    ...
    return /* @__PURE__ */ u3("div", { children: [
      /* @__PURE__ */ u3("h2", { children: "DB Viewer" }),
      /* @__PURE__ */ u3(Button, { onClick: sendGreeting, children: "Click Me" }),
      /* @__PURE__ */ u3(Button, { style: "margin-top: 20px;", onClick: handleFileUpload, children: "Select SQLite DB" }),
      /* @__PURE__ */ u3("div", { style: "margin-top: 20px;", children: /* @__PURE__ */ u3("ul", { children: tables.map((table) => /* @__PURE__ */ u3("li", { children: [
        /* @__PURE__ */ u3("span", { onClick: () => handleExpandTable(table.tableName), children: table.tableName }),
        /* @__PURE__ */ u3("ul", { children: table.columns.map((col) => /* @__PURE__ */ u3("li", { children: col }, col)) })
      ] }, table.tableName)) }) })
    ] });
  };
  D(/* @__PURE__ */ u3(App, {}), document.getElementById("app"));
})();
